...
const About = () => {
  return (
    <>
      ...
      Currently, I work for Penn State's Computer Science Department as a grader for the CMPSC 132 Data Structures and Algorithms course. I am also an avid 3D printing hobbist and hold the position of treasurer in the Penn State 3D Printing Club.
